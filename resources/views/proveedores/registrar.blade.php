    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">REGISTRAR NUEVO PROVEEDOR</h5>
        </div>
          ...
          <form action="{{ route('proveedores.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="ejemplo@email.com...">
                </div>
                <div class="form-group col-md-6">
